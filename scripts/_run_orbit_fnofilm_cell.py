"""Run a single FNO+FiLM orbit OOD cell. Mirrors _run_orbit_h100_cell.py."""
...
if __name__ == "__main__":
    ...
    from _orbit_fnofilm_cells import all_cells
    cells = all_cells()
    if cell_idx >= len(cells):
        print(f"[run-cell] cell_idx {cell_idx} out of range", file=sys.stderr)
        sys.exit(2)
    cell = cells[cell_idx]
